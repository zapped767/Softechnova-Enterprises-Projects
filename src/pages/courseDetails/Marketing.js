...
function Marketing() {
  const modules = [
    ...
    { title: "Social Media & Content Marketing", duration: "3 hours" },
    { title: "SEO and Google Ads", duration: "4 hours" },
    { title: "Email Marketing", duration: "2 hours" },
    { title: "Marketing Analytics", duration: "3 hours" },
    { title: "Capstone Project", duration: "5 hours" }
  ];

  return (
    <div className="course-detail marketing">
