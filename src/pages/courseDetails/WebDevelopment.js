...
function WebDevelopment() {
  const modules = [
    ...
    { title: "React.js Essentials", duration: "6 hours" },
    { title: "Backend with Node.js", duration: "5 hours" },
    { title: "Databases and MongoDB", duration: "4 hours" },
    { title: "Final Full Stack Project", duration: "8 hours" }
  ];

  return (
    <div className="course-detail webdev">
